...
#define ARDUINO_D10_SPI1_NSS_Pin GPIO_PIN_14
#define ARDUINO_D10_SPI1_NSS_GPIO_Port GPIOD
#define ARDUINO_D9_DATAREADY_Pin GPIO_PIN_15
#define ARDUINO_D9_DATAREADY_GPIO_Port GPIOD
